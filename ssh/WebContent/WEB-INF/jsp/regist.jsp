...
<script>
	...
	function checkUsername() {
		...
		xh.onreadystatechange=function(){
			if(xh.readyState == 4){
				if(xh.status == 200){
					document.getElementById("span1").innerHTML = xh.responseText;
				}
			}
		}
		//打开连接
		xh.open("GET","${pageContext.request.contextPath}/user_findByName.action?time="+new Date().getTime()+"&username="+username,true);
		//发送
		xh.send(null);
	}
	...
	function change(){
		var imgl=document.getElementById("checkImg");
		imgl.src="${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();
	}
</script>
</head>
<body>
							...
							<tr>
								...
								<td>
									...
									<tr>
										...
										<td>
												<input type="text" name="name" id="name" class="text" maxlength="200"><span><s:fielderror fieldName="name"/></span>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
												<input type="text" name="tell" class="text" id="tell" onfocus="WdatePicker();"><span><s:fielderror fieldName="tell"/></span>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
												<input type="text" name="addr" class="text" id="addr" maxlength="200"><span><s:fielderror fieldName="addr"/></span>
										</td>
									</tr>
								<tr>
									<th>
